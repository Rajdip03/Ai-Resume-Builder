...
const Features = () => {
  ...
  return (
    <div id='features' className='flex flex-col item-center mmy-10 scroll-mt-12'>

    <div className="inline-flex items-center justify-center gap-2 text-sm text-green-800 bg-green-400/10  rounded-full px-6 py-1.5 mb-4 mx-auto">
    <Zap  width={14}/>
    ...
    <style>{`
        ...
        *{
        ...
        `}</style>
            ...
            <p className="text-sm text-slate-500 text-center mt-2 max-w-md mx-auto">Our process helps you create a professional resume in minutes with intelligent AI-powered tools and features.</p>
